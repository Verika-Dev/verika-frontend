      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div
            ...
            style={{
              backgroundImage: `linear-gradient(to bottom, rgba(30,86,175,0.8), rgba(13,36,73,0.8)), url(${laptopBg.src})`,
            }}>
            {/* Purple Background Blob */}
            {/* <div className="absolute inset-0 bg-gradient-to-b from-[#1E56AF] to-[#0D2449] rounded-lg h-full"></div> */}
          </div>
              ...
              {values.map((value, index) => (
                <div key={index} className="flex gap-4">
                  ...
                  <div className="flex-shrink-0">
                    <div
                      className={`w-12 h-12 bg-gradient-to-br rounded-xl flex items-center justify-center text-white shadow-md`}>
                      {value.icon}
                    </div>
                  </div>
